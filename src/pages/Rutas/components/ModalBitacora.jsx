...
const ModalBitacora = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[120] flex items-center justify-center p-2 sm:p-6 transition-opacity">
      <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl w-full max-w-6xl shadow-2xl overflow-hidden flex flex-col h-[85vh] transform-gpu">
